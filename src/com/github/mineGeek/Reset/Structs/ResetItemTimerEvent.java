...
public class ResetItemTimerEvent implements ITimer, Runnable {

	public ResetItem parent = null;
	
	public ResetItemTimerEvent( ResetItem resetItem ) { parent = resetItem; }
